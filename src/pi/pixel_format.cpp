...
// Pure pixel-format utilities — no platform or device dependencies.
// Included in ALL platform builds (android.cmake, macos.cmake, etc.) and
// compiled directly into the universal test target.
